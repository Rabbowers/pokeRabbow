...
static const u8 sDoorAnimTiles_Seaton[] = INCBIN_U8("graphics/door_anims/seaton.4bpp");
...
static const u8 sDoorAnimPalettes_Seaton[] = {6, 6, 6, 6, 6, 6, 6, 6};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Seaton_Door,                                  DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Seaton, sDoorAnimPalettes_Seaton},
    {},
};
