...
const u16 gMetatiles_Seaton[] = INCBIN_U16("data/tilesets/secondary/seaton/metatiles.bin");
const u16 gMetatileAttributes_Seaton[] = INCBIN_U16("data/tilesets/secondary/seaton/metatile_attributes.bin");
