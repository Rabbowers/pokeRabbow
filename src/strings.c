...
//names
const u8 gText_SideQuestName_1[] = _("ZIGZAGOON LOST");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("An artist's ZIGZAGOON has gone missing");
...
const u8 gText_SideQuestDoneDesc_1[] = _("An artist's ZIGZAGOON had gone missing, but you found it");
...
//subquests
const u8 gText_SubQuest1_Name1[] = _("Go North");

const u8 gText_SubQuest1_Desc1[] = _("The Zigzagoon went home,\n return for a reward");

const u8 gText_SubQuest1_Map1[] = _("ROUTE 103");
